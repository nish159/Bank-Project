namespace DataAccess
{
    ...
    public class AccountsCosmosDbRepository : IAccountRepository
    {
        ...
        public async Task<Result<Account>> DeleteAccount(Account deletedAccount)
        {
        ...
        public async Task<Result<Account>> UpdateAccount(Account updatedAccount)
        {
        ...
        public async Task<Result<Account>> GetById(string id)
        {
            // Building the sql query
